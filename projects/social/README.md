...
1. To create 100 users with an average of 10 friends each, how many times would you need to call `add_friendship()`? Why?
    # you would need to call add friend ship 500 times. 
    # because 100 users * 10 friends each is 1000 friends, but (2,1) == (1, 2) due undirected graph so we get 1000/2 = 500
